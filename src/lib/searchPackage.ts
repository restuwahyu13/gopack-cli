																																							...
																																							question(prompt, (answer11) => {
																																								choice(prompt, answer11, async (data13, response13) => {
																																									if (data13.confirms === true) {
																																										...
																																										writeData('gopack.txt', response13)
																																										gopack.checkGomod()
																																										gopack.checkGolangPackage()
																																									}
																																								})
